...
export default {
  ...
  settings: {
    ...
    imprint: 'Juridiskt meddelande',
    privacyPolicy: 'Integritetspolicy',
    termsAndConditions: 'Användarvillkor',
    exportData: 'Exportera mina uppgifter',
    exportDataDescription: 'Ladda ner en kopia av alla dina personuppgifter (GDPR Art. 20)',
    exportDataSuccess: 'Din dataexport har börjat laddas ned.',
    exportDataError: 'Kunde inte exportera data. Försök igen.',
    contactUs: 'Kontakta oss',
    minAgeNotice: 'Genom att registrera dig bekräftar du att du är minst 16 år gammal.',
