...
export default {
  ...
  settings: {
    ...
    exportDataDescription: 'Download a copy of all your personal data (GDPR Art. 20)',
    exportDataSuccess: 'Your data export has started downloading.',
    exportDataError: 'Failed to export data. Please try again.',
    contactUs: 'Contact Us',
    minAgeNotice: 'By registering, you confirm you are at least 16 years old.',
